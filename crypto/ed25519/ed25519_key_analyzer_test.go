...
import "github.com/proximax/nem2-go-sdk/sdk/core/crypto" //keyanalyzertest"
type Ed25519KeyAnalyzerTest struct { /* public  */  
    KeyAnalyzerTest /* extends */ 
  
// @Override
    func (ref *Ed25519KeyAnalyzerTest) getCryptoEngine() CryptoEngine  { /* protected  */  

        return CryptoEngines.ed25519Engine() 
}
} /* Ed25519KeyAnalyzerTest */ 
