...
// IncomingTransactions return an array of transactions for which an account is the recipient of a transaction.
...
// OutgoingTransactions return an array of transactions for which an account is the sender a transaction.
...
// UnconfirmedTransactions return the array of transactions for which an account is the sender or receiver and which have not yet been included in a block.
...
// AggregateBondedTransactions return an array of transactions for which an account is the sender or has sign the transaction.
